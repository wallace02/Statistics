...
def FiltroByPathLoss(FilesList, opcao):
	...
	FS10E2ED, FS10RATE, FS25E2ED, FS25RATE, FS50E2ED, FS50RATE, FS75E2ED, FS75RATE, FS100E2ED, FS100RATE  = [defaultdict(list) for dummy in range(10)]
	LNS10E2ED, LNS10RATE, LNS25E2ED, LNS25RATE, LNS50E2ED, LNS50RATE, LNS75E2ED, LNS75RATE, LNS100E2ED, LNS100RATE  = [defaultdict(list) for dummy in range(10)]
	NAK10E2ED, NAK10RATE, NAK25E2ED, NAK25RATE, NAK50E2ED, NAK50RATE, NAK75E2ED, NAK75RATE, NAK100E2ED, NAK100RATE  = [defaultdict(list) for dummy in range(10)]
	TRG10E2ED, TRG10RATE, TRG25E2ED, TRG25RATE, TRG50E2ED, TRG50RATE, TRG75E2ED, TRG75RATE, TRG100E2ED, TRG100RATE  = [defaultdict(list) for dummy in range(10)]
					...
					if '-FS-' in k:
						if '-10n-' in k:
							if 'endToEndDelay' in k:
								FS10E2ED[E2ED].append(v)
							if 'rcvdPk' in k:
								FS10RATE[Recived].append(v)
							if 'sentPk' in k:
								FS10RATE[Sent].append(v)
						if '-25n-' in k:
							if 'endToEndDelay' in k:
						...
						if '-10n-' in k:
							if 'endToEndDelay' in k:
								LNS10E2ED[E2ED].append(v)
							if 'rcvdPk' in k:
								LNS10RATE[Recived].append(v)
							if 'sentPk' in k:
								LNS10RATE[Sent].append(v)
						if '-25n-' in k:
							if 'endToEndDelay' in k:
						...
						if '-10n-' in k:
							if 'endToEndDelay' in k:
								TRG10E2ED[E2ED].append(v)
							if 'rcvdPk' in k:
								TRG10RATE[Recived].append(v)
							if 'sentPk' in k:
								TRG10RATE[Sent].append(v)
						if '-25n-' in k:
							if 'endToEndDelay' in k:
	...
	"""
						...
						if '-10n-' in k:
							if 'endToEndDelay' in k:
								NAK10E2ED[E2ED].append(v)
							if 'rcvdPk' in k:
								NAK10RATE[Recived].append(v)
							if 'sentPk' in k:
								NAK10RATE[Sent].append(v)
						if '-25n-' in k:
							if 'endToEndDelay' in k:
	...
	"""
	FS = [FS10E2ED, FS10RATE, FS25E2ED, FS25RATE, FS50E2ED, FS50RATE, FS75E2ED, FS75RATE, FS100E2ED, FS100RATE]
	LNS = [LNS10E2ED, LNS10RATE, LNS25E2ED, LNS25RATE, LNS50E2ED, LNS50RATE, LNS75E2ED, LNS75RATE, LNS100E2ED, LNS100RATE]
	TRG = [TRG10E2ED, TRG10RATE, TRG25E2ED, TRG25RATE, TRG50E2ED, TRG50RATE, TRG75E2ED, TRG75RATE, TRG100E2ED, TRG100RATE]
	#NAK = [DYMO10E2ED, DYMO10RATE, DYMO25E2ED, DYMO25RATE, DYMO50E2ED, DYMO50RATE, DYMO75E2ED, DYMO75RATE, DYMO100E2ED, DYMO100RATE]
	Protocolos = [FS,LNS,TRG] #[FS,LNS,NAK,TRG]

	FSMean, FSDesv, FSPDR, NAKMean, NAKDesv, NAKPDR, TRGMean, TRGDesv, TRGPDR, LNSMean, LNSDesv, LNSPDR  = [[0]*5 for dummy in range(12)]
	...
	plt.title('Impact of AODV over Pathloss', fontsize=20)
	...
	plt.savefig('AODV-E2ED.png', format='png')
	#plt.show()
	...
	plt.savefig('AODV-PDR.png', format='png')
	#plt.show()
